...
RSpec.describe "Batch management" do
  ...
  context "when alma returns an error" do
    it "can create multiple absolute identifiers", js: true do
      stub_alma_barcode(barcode: "32101091123743", status: 504)
      stub_alma_barcode(barcode: "32101097107245", status: 504)
  ...
  context "when alma returns without error" do
