...
module AspaceStubbing
  ...
  def stub_top_container_search(ead_id:, repository_id:, indicators:)
    ...
    uri += "?fields[]=uri&fields[]=indicator_u_icusort&page=1&q=collection_identifier_u_stext:#{ead_id}%20indicator_u_icusort:%5B#{indicators.first}%20TO%20#{indicators.last}%5D&type%5B%5D=top_container"
